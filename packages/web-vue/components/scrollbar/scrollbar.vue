<template>
  <div :class="cls" :style="style">
    <ResizeObserver @resize="handleResize">
      <div
        ref="containerRef"
        :class="[`${prefixCls}-container`, containerClass]"
...
export default defineComponent({
  ...
  props: {
    type: {
      type: String as PropType<'default' | 'track'>,
      default: 'default',
    },
    containerClass: [String, Object, Array],
    containerStyle: [String, Object, Array] as PropType<StyleValue>,
  },
  emits: {
    ...
    const getContainerSize = () => {
      if (containerRef.value) {
        ...
        const horizontalTrackWidth =
          props.type === 'default' && isBoth.value
